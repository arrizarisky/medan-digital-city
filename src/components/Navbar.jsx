...
// ── INDEX KONTEN GLOBAL ──────────────────────────────────────
// Setiap item berisi: title (ditampilkan), category (label), path (navigasi), keywords
...
function getResultCategory(result) {
  // Ambil emoji ikon berdasarkan kategori
  const iconMap = {
    'Wisata Sejarah': '🏛️',
    'Wisata Religi': '🕌',
    'Wisata Alam': '🌿',
...
export default function Navbar({ lang = "id", setLang }) {
  ...
  // Fokus input saat search panel terbuka
  useEffect(() => {
  ...
  // Filter hasil pencarian konten global
                ...
                {searchResults.length > 0 ? (
                  searchResults.map((result, i) => (
                    ...
                    >
                      ...
                      {/* Teks — hanya judul & kategori, tanpa path */}
          ...
          <div className="flex h-16 items-center justify-between gap-4 px-4 md:px-6">
            <div className="flex w-full items-center justify-between gap-3 md:w-auto">
              <Link to="/" className="flex items-center gap-2 text-xl font-bold">
                <img src={Logo} alt="Logo Kota Medan" className="h-10 w-10 object-contain" />
                <img src="https://medantourism.medan.go.id/assets/images/medan_untuk_semua.png" alt="Medan Untuk Semua" className="h-18 w-18 object-contain" />
                <img src="https://medantourism.medan.go.id/assets/images/logo_colorful_medan.png" alt="Colorful Medan" className="h-18 w-18 object-contain" />
                <img src="https://medantourism.medan.go.id/assets/images/medan_bangga.png" alt="Medan Bangga" className="h-18 w-18 object-contain" />
                <img src="https://medantourism.medan.go.id/assets/images/logo_wonderful.png" alt="Wonderful Indonesia" className="h-18 w-18 object-contain" />
              </Link>
