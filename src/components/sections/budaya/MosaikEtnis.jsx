    ...
    <section ref={sectionRef} className="reveal-up relative z-10">
      <div className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 grid-flow-dense gap-6">
          ...
          <div className="col-span-1 md:col-span-8 group relative rounded-[2rem] overflow-hidden aspect-[16/9] bg-stone-100 shadow-lg">
          ...
          <div className="col-span-1 md:col-span-4 md:row-span-2 group relative rounded-[2rem] overflow-hidden aspect-[3/4] md:aspect-auto h-full bg-stone-100 shadow-lg">
          ...
          <div className="col-span-1 md:col-span-4 group relative rounded-[2rem] overflow-hidden aspect-square md:aspect-[4/3] bg-stone-100 shadow-lg">
          ...
          <div className="col-span-1 md:col-span-6 group relative rounded-[2rem] overflow-hidden aspect-video bg-stone-100 shadow-lg">
