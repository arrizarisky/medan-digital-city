    ...
    <GsapScrollReveal className="w-full bg-[#F4F4F4F4] py-20 px-4 md:px-8 lg:px-16">
      <div className="mx-auto max-w-6xl" data-gsap-section>
        <div className="flex flex-col items-center text-center mb-12">
          <span className="text-[#6B8E23] text-xs font-bold uppercase tracking-widest mb-4 block" data-gsap-reveal>
            {header}
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-[40px] font-bold font-montserrat text-black/90 leading-tight" data-gsap-reveal>
