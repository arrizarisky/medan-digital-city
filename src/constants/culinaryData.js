  ...
  items: [
    {
      ...
      imageUrl: "/images/lontong-medan.jpg", // Taruh di folder public/images/
      gridClass:
    ...
    },
    {
      ...
      imageUrl: "/images/jus-martabe.jpg",
      gridClass:
        "col-span-12 sm:col-span-6 lg:col-span-5 aspect-[4/3] lg:aspect-auto",
    },
    {
      id: 4,
      title: "Ucok Durian",
      category: "camilan", // Bisa disesuaikan konteks ikonik
      tag: "Ikonik",
      isMustTry: false,
      desc: "Raja durian dengan kualitas premium yang mendunia.",
      imageUrl: "/images/ucok-durian.jpg",
